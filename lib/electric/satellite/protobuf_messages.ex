...
[
  defmodule Electric.Satellite.V03.SatAuthHeader do
    @moduledoc false
    (
      defstruct []
  ...
  defmodule Electric.Satellite.V03.SatErrorResp.ErrorCode do
    @moduledoc false
    (
      defstruct []
  ...
  defmodule Electric.Satellite.V03.SatInStartReplicationReq.Option do
    @moduledoc false
    (
      defstruct []
  ...
  defmodule Electric.Satellite.V03.SatRelation.RelationType do
    @moduledoc false
    (
      defstruct []
  ...
  defmodule Electric.Satellite.V03.SatAuthHeaderPair do
    @moduledoc false
          ...
          try do
            if msg.key == :UNSPECIFIED do
              ...
              [
                ...
                "\b",
                msg.key
                |> Electric.Satellite.V03.SatAuthHeader.encode()
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatAuthHeaderPair))
          end
        )
      )
        ...
        defp parse_key_value(bytes, msg) do
          {field, rest} =
            case Protox.Decode.parse_key(bytes) do
              ...
              {1, _, bytes} ->
                {value, rest} =
                  Protox.Decode.parse_enum(bytes, Electric.Satellite.V03.SatAuthHeader)
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatAuthHeaderPair,
    ...
    (
      ...
      def defs() do
        %{
          1 => {:key, {:scalar, :UNSPECIFIED}, {:enum, Electric.Satellite.V03.SatAuthHeader}},
      ...
      def defs_by_name() do
        %{
          key: {1, {:scalar, :UNSPECIFIED}, {:enum, Electric.Satellite.V03.SatAuthHeader}},
      ...
      def fields_defs() do
        [
          %{
            ...
            name: :key,
            tag: 1,
            type: {:enum, Electric.Satellite.V03.SatAuthHeader}
          },
          %{
            __struct__: Protox.Field,
            json_name: "value",
  ...
  defmodule Electric.Satellite.V03.SatAuthReq do
    @moduledoc false
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatAuthReq))
          end
        )
      )
          ...
          {field, rest} =
            case Protox.Decode.parse_key(bytes) do
              ...
              {3, _, bytes} ->
                ...
                {[
                   headers:
                     msg.headers ++ [Electric.Satellite.V03.SatAuthHeaderPair.decode!(delimited)]
                 ], rest}
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatAuthReq,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
    ...
    (
      ...
      def defs() do
        %{
          ...
          3 => {:headers, :unpacked, {:message, Electric.Satellite.V03.SatAuthHeaderPair}}
        }
      end
      ...
      def defs_by_name() do
        %{
          headers: {3, :unpacked, {:message, Electric.Satellite.V03.SatAuthHeaderPair}},
          id: {1, {:scalar, ""}, :string},
      ...
      def fields_defs() do
        [
          ...
          %{
            ...
            name: :headers,
            tag: 3,
            type: {:message, Electric.Satellite.V03.SatAuthHeaderPair}
          }
        ]
      end
  ...
  defmodule Electric.Satellite.V03.SatAuthResp do
    @moduledoc false
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatAuthResp))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatAuthResp,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
  ...
  defmodule Electric.Satellite.V03.SatErrorResp do
    @moduledoc false
          ...
          try do
            if msg.error_type == :INTERNAL do
              ...
              [
                ...
                "\b",
                msg.error_type
                |> Electric.Satellite.V03.SatErrorResp.ErrorCode.encode()
                |> Protox.Encode.encode_enum()
              ]
            end
          rescue
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatErrorResp))
          end
        )
      )
        ...
        defp parse_key_value(bytes, msg) do
          {field, rest} =
            case Protox.Decode.parse_key(bytes) do
              ...
              {1, _, bytes} ->
                {value, rest} =
                  Protox.Decode.parse_enum(bytes, Electric.Satellite.V03.SatErrorResp.ErrorCode)
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatErrorResp,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
    ...
    (
        ...
        %{
          1 =>
            {:error_type, {:scalar, :INTERNAL},
             {:enum, Electric.Satellite.V03.SatErrorResp.ErrorCode}}
        }
      end
      ...
      def defs_by_name() do
        %{
          error_type:
            {1, {:scalar, :INTERNAL}, {:enum, Electric.Satellite.V03.SatErrorResp.ErrorCode}}
        }
      end
    )
      ...
      def fields_defs() do
        [
          %{
            ...
            name: :error_type,
            tag: 1,
            type: {:enum, Electric.Satellite.V03.SatErrorResp.ErrorCode}
          }
        ]
      end
  ...
  defmodule Electric.Satellite.V03.SatInStartReplicationReq do
    @moduledoc false
                    ...
                    {bytes, len} =
                      Enum.reduce(values, {[], 0}, fn value, {acc, len} ->
                        value_bytes =
                          :binary.list_to_bin([
                            value
                            |> Electric.Satellite.V03.SatInStartReplicationReq.Option.encode()
                            |> Protox.Encode.encode_enum()
                          ])
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatInStartReplicationReq))
          end
        )
      )
                   ...
                   options:
                     msg.options ++
                       Protox.Decode.parse_repeated_enum(
                         [],
                         delimited,
                         Electric.Satellite.V03.SatInStartReplicationReq.Option
                       )
                 ], rest}
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatInStartReplicationReq,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
    ...
    (
      ...
      def defs() do
        %{
          1 => {:lsn, {:scalar, ""}, :bytes},
          2 =>
            {:options, :packed, {:enum, Electric.Satellite.V03.SatInStartReplicationReq.Option}},
      ...
      def defs_by_name() do
        %{
          lsn: {1, {:scalar, ""}, :bytes},
          options: {2, :packed, {:enum, Electric.Satellite.V03.SatInStartReplicationReq.Option}},
      ...
      def fields_defs() do
        [
          ...
          %{
            ...
            name: :options,
            tag: 2,
            type: {:enum, Electric.Satellite.V03.SatInStartReplicationReq.Option}
          },
          %{
            __struct__: Protox.Field,
  ...
  defmodule Electric.Satellite.V03.SatInStartReplicationResp do
    @moduledoc false
    defstruct __uf__: []
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatInStartReplicationResp))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatInStartReplicationResp,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
  ...
  defmodule Electric.Satellite.V03.SatInStopReplicationReq do
    @moduledoc false
    defstruct __uf__: []
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatInStopReplicationReq))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatInStopReplicationReq,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
  ...
  defmodule Electric.Satellite.V03.SatInStopReplicationResp do
    @moduledoc false
    defstruct __uf__: []
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatInStopReplicationResp))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatInStopReplicationResp,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
  ...
  defmodule Electric.Satellite.V03.SatMigrationNotification do
    @moduledoc false
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatMigrationNotification))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatMigrationNotification,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
  ...
  defmodule Electric.Satellite.V03.SatOpBegin do
    @moduledoc false
    defstruct commit_timestamp: 0, trans_id: "", lsn: "", origin: nil, __uf__: []
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatOpBegin))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatOpBegin,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
  ...
  defmodule Electric.Satellite.V03.SatOpCommit do
    @moduledoc false
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatOpCommit))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatOpCommit,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
  ...
  defmodule Electric.Satellite.V03.SatOpDelete do
    @moduledoc false
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatOpDelete))
          end
        )
      )
                ...
                {[
                   old_row_data:
                     Protox.MergeMessage.merge(
                       msg.old_row_data,
                       Electric.Satellite.V03.SatOpRow.decode!(delimited)
                     )
                 ], rest}
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatOpDelete,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
    ...
    (
      ...
      def defs() do
        %{
          ...
          2 => {:old_row_data, {:scalar, nil}, {:message, Electric.Satellite.V03.SatOpRow}},
      ...
      def defs_by_name() do
        %{
          old_row_data: {2, {:scalar, nil}, {:message, Electric.Satellite.V03.SatOpRow}},
      ...
      def fields_defs() do
        [
          ...
          %{
            ...
            name: :old_row_data,
            tag: 2,
            type: {:message, Electric.Satellite.V03.SatOpRow}
          },
          %{
            __struct__: Protox.Field,
            json_name: "tags",
  ...
  defmodule Electric.Satellite.V03.SatOpInsert do
    @moduledoc false
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatOpInsert))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatOpInsert,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
    ...
    (
      ...
      def defs() do
        %{
          1 => {:relation_id, {:scalar, 0}, :uint32},
          2 => {:row_data, {:scalar, nil}, {:message, Electric.Satellite.V03.SatOpRow}},
          3 => {:tags, :unpacked, :string}
        }
      end
      ...
      def defs_by_name() do
        %{
          relation_id: {1, {:scalar, 0}, :uint32},
          row_data: {2, {:scalar, nil}, {:message, Electric.Satellite.V03.SatOpRow}},
          tags: {3, :unpacked, :string}
        }
      end
    )
  ...
  defmodule Electric.Satellite.V03.SatOpLog do
    @moduledoc false
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatOpLog))
          end
        )
      )
          ...
          {field, rest} =
            case Protox.Decode.parse_key(bytes) do
              ...
              {1, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[ops: msg.ops ++ [Electric.Satellite.V03.SatTransOp.decode!(delimited)]], rest}
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatOpLog,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
    ...
    (
      ...
      def defs() do
        %{1 => {:ops, :unpacked, {:message, Electric.Satellite.V03.SatTransOp}}}
      end
      ...
      def defs_by_name() do
        %{ops: {1, :unpacked, {:message, Electric.Satellite.V03.SatTransOp}}}
      end
    )
      ...
      def fields_defs() do
        [
          %{
            ...
            name: :ops,
            tag: 1,
            type: {:message, Electric.Satellite.V03.SatTransOp}
          }
        ]
      end
  ...
  defmodule Electric.Satellite.V03.SatOpRow do
    @moduledoc false
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatOpRow))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatOpRow,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
  ...
  defmodule Electric.Satellite.V03.SatOpUpdate do
    @moduledoc false
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatOpUpdate))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatOpUpdate,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
    ...
    (
      ...
      def defs() do
        %{
          1 => {:relation_id, {:scalar, 0}, :uint32},
          2 => {:row_data, {:scalar, nil}, {:message, Electric.Satellite.V03.SatOpRow}},
          3 => {:old_row_data, {:scalar, nil}, {:message, Electric.Satellite.V03.SatOpRow}},
      ...
      def defs_by_name() do
        %{
          old_row_data: {3, {:scalar, nil}, {:message, Electric.Satellite.V03.SatOpRow}},
          relation_id: {1, {:scalar, 0}, :uint32},
          row_data: {2, {:scalar, nil}, {:message, Electric.Satellite.V03.SatOpRow}},
  ...
  defmodule Electric.Satellite.V03.SatPingReq do
    @moduledoc false
    defstruct __uf__: []
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatPingReq))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatPingReq,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
  ...
  defmodule Electric.Satellite.V03.SatPingResp do
    @moduledoc false
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatPingResp))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatPingResp,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
  ...
  defmodule Electric.Satellite.V03.SatRelation do
    @moduledoc false
          ...
          try do
            if msg.table_type == :TABLE do
              ...
              [
                ...
                "\x10",
                msg.table_type
                |> Electric.Satellite.V03.SatRelation.RelationType.encode()
                |> Protox.Encode.encode_enum()
              ]
            end
          rescue
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatRelation))
          end
        )
      )
        ...
        defp parse_key_value(bytes, msg) do
          {field, rest} =
            case Protox.Decode.parse_key(bytes) do
              ...
              {2, _, bytes} ->
                {value, rest} =
                  Protox.Decode.parse_enum(bytes, Electric.Satellite.V03.SatRelation.RelationType)
              ...
              {5, _, bytes} ->
                ...
                {[
                   columns:
                     msg.columns ++ [Electric.Satellite.V03.SatRelationColumn.decode!(delimited)]
                 ], rest}
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatRelation,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
    ...
    (
        ...
        %{
          ...
          2 =>
            {:table_type, {:scalar, :TABLE},
             {:enum, Electric.Satellite.V03.SatRelation.RelationType}},
          3 => {:table_name, {:scalar, ""}, :string},
          4 => {:relation_id, {:scalar, 0}, :uint32},
          5 => {:columns, :unpacked, {:message, Electric.Satellite.V03.SatRelationColumn}}
        }
      end
      ...
      def defs_by_name() do
        %{
          columns: {5, :unpacked, {:message, Electric.Satellite.V03.SatRelationColumn}},
          relation_id: {4, {:scalar, 0}, :uint32},
          schema_name: {1, {:scalar, ""}, :string},
          table_name: {3, {:scalar, ""}, :string},
          table_type:
            {2, {:scalar, :TABLE}, {:enum, Electric.Satellite.V03.SatRelation.RelationType}}
        }
      end
    )
      ...
      def fields_defs() do
        [
          ...
          %{
            ...
            name: :table_type,
            tag: 2,
            type: {:enum, Electric.Satellite.V03.SatRelation.RelationType}
          },
          %{
            __struct__: Protox.Field,
            json_name: "tableName",
          ...
          %{
            ...
            name: :columns,
            tag: 5,
            type: {:message, Electric.Satellite.V03.SatRelationColumn}
          }
        ]
      end
  ...
  defmodule Electric.Satellite.V03.SatRelationColumn do
    @moduledoc false
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatRelationColumn))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatRelationColumn,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
  ...
  defmodule Electric.Satellite.V03.SatTransOp do
    @moduledoc false
    ...
    (
      (
        ...
        (
          @spec decode!(binary) :: struct | no_return
          def decode!(bytes) do
            parse_key_value(bytes, struct(Electric.Satellite.V03.SatTransOp))
          end
        )
      )
                     ...
                     {:begin, previous_value} ->
                       {:op,
                        {:begin,
                         Protox.MergeMessage.merge(
                           previous_value,
                           Electric.Satellite.V03.SatOpBegin.decode!(delimited)
                         )}}

                     _ ->
                       {:op, {:begin, Electric.Satellite.V03.SatOpBegin.decode!(delimited)}}
                   end
                 ], rest}
                     ...
                     {:commit, previous_value} ->
                       {:op,
                        {:commit,
                         Protox.MergeMessage.merge(
                           previous_value,
                           Electric.Satellite.V03.SatOpCommit.decode!(delimited)
                         )}}

                     _ ->
                       {:op, {:commit, Electric.Satellite.V03.SatOpCommit.decode!(delimited)}}
                   end
                 ], rest}
                     ...
                     {:update, previous_value} ->
                       {:op,
                        {:update,
                         Protox.MergeMessage.merge(
                           previous_value,
                           Electric.Satellite.V03.SatOpUpdate.decode!(delimited)
                         )}}

                     _ ->
                       {:op, {:update, Electric.Satellite.V03.SatOpUpdate.decode!(delimited)}}
                   end
                 ], rest}
                     ...
                     {:insert, previous_value} ->
                       {:op,
                        {:insert,
                         Protox.MergeMessage.merge(
                           previous_value,
                           Electric.Satellite.V03.SatOpInsert.decode!(delimited)
                         )}}

                     _ ->
                       {:op, {:insert, Electric.Satellite.V03.SatOpInsert.decode!(delimited)}}
                   end
                 ], rest}
                     ...
                     {:delete, previous_value} ->
                       {:op,
                        {:delete,
                         Protox.MergeMessage.merge(
                           previous_value,
                           Electric.Satellite.V03.SatOpDelete.decode!(delimited)
                         )}}

                     _ ->
                       {:op, {:delete, Electric.Satellite.V03.SatOpDelete.decode!(delimited)}}
                   end
                 ], rest}
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Electric.Satellite.V03.SatTransOp,
          &json_library_wrapper.decode!(json_library, &1)
        )
      end
    ...
    (
      ...
      def defs() do
        %{
          1 => {:begin, {:oneof, :op}, {:message, Electric.Satellite.V03.SatOpBegin}},
          2 => {:commit, {:oneof, :op}, {:message, Electric.Satellite.V03.SatOpCommit}},
          3 => {:update, {:oneof, :op}, {:message, Electric.Satellite.V03.SatOpUpdate}},
          4 => {:insert, {:oneof, :op}, {:message, Electric.Satellite.V03.SatOpInsert}},
          5 => {:delete, {:oneof, :op}, {:message, Electric.Satellite.V03.SatOpDelete}}
        }
      end
      ...
      def defs_by_name() do
        %{
          begin: {1, {:oneof, :op}, {:message, Electric.Satellite.V03.SatOpBegin}},
          commit: {2, {:oneof, :op}, {:message, Electric.Satellite.V03.SatOpCommit}},
          delete: {5, {:oneof, :op}, {:message, Electric.Satellite.V03.SatOpDelete}},
          insert: {4, {:oneof, :op}, {:message, Electric.Satellite.V03.SatOpInsert}},
          update: {3, {:oneof, :op}, {:message, Electric.Satellite.V03.SatOpUpdate}}
        }
      end
    )
      ...
      def fields_defs() do
        [
          %{
            ...
            name: :begin,
            tag: 1,
            type: {:message, Electric.Satellite.V03.SatOpBegin}
          },
          %{
            __struct__: Protox.Field,
            json_name: "commit",
            ...
            name: :commit,
            tag: 2,
            type: {:message, Electric.Satellite.V03.SatOpCommit}
          },
          %{
            __struct__: Protox.Field,
            json_name: "update",
            ...
            name: :update,
            tag: 3,
            type: {:message, Electric.Satellite.V03.SatOpUpdate}
          },
          %{
            __struct__: Protox.Field,
            json_name: "insert",
            ...
            name: :insert,
            tag: 4,
            type: {:message, Electric.Satellite.V03.SatOpInsert}
          },
          %{
            __struct__: Protox.Field,
            json_name: "delete",
            ...
            name: :delete,
            tag: 5,
            type: {:message, Electric.Satellite.V03.SatOpDelete}
          }
        ]
      end
